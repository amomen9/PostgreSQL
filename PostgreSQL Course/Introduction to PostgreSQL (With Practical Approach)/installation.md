...
However, later we discuss moving the data directory here for learning purposes. This might also be used somewhere by some of you if it complies with your taste and needs.
...
First, add the recommended and required repositories to `/etc/apk/repositories`. <ins>Be careful to replace the Alpine major version with your Alpine version</ins>.
